...
Etapa 4 — play area 16:9 (`js/play-area-scale.js`), escalado tipográfico y wrapper interno con pie de evaluación fuera del lienzo. Pendiente: popup de feedback y apariencia por actividad (etapas 5+).
